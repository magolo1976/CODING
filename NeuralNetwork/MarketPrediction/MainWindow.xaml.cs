...
public partial class MainWindow : Window
{
    ...
    private void btnTrain_Click(object sender, RoutedEventArgs e)
    {
        ...
        string filePath = "C:\\MAGOLO\\gitCODING\\NeuralNetwork\\StudyCaseLibrary\\Assets\\SAVE_to_FILE.csv";
    ...
    private void StudyCase_OnTrainingEvent(OnTrainingEventArgs args)
    {
        Dispatcher.Invoke(() =>
        {
            ...
            //);
            string Text = string.Format("Epochs to Go: {0}, MSE: {1:F4}\n",
                (args.TotalEpochs - args.CurrentEpoch), args.Mse
            );
            ...
            if (_currentMse != args.Mse)
                PlotView.Refresh();
            
            _currentMse = args.Mse;
        });
    }
