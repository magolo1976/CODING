namespace MTT_RuleExtraction
{
    ...
    public class CalculateRandomMetricsCompound
    {
        /***** PYTHON 
def calculate_random_metrics_compound(returns, side='long', n_simulations=1000):
    ...
    return np.array(random_metrics)          
        */
        ...
        /// <summary>
        /// Calcula los monos para reglas compuestas usando longitud_de_retornos/9
        /// </summary>
        public static double[] Calculate_Random_Metrics_Compound(List<double> returns, string side = "long", int nSimulations = 1000)
        {
